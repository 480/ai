...
The user's time is expensive. The purpose of the scan is to remove avoidable stack and tooling questions early so the architect and developer can stay inside the approved flow with fewer unnecessary interruptions.
