...
- If the repository is unfamiliar, spawn `480-code-scanner` only if the parent developer explicitly asked you to do so or if you truly need it to understand repo conventions.
...
- Do not make `새 세션` or `예외 허용` the default path in review feedback.
