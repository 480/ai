...
- Codex uses a native subagent workflow. The root architect session spawns `480-developer`/reviewer/scanner subagents as needed.
- The default delegation depth is 1: architect(depth 0) -> subagents(depth 1). Subagents do not spawn additional subagents.
