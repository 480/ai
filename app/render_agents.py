...
def render_codex_agents_index(
    ...
    lines = [
        ...
        "",
            ...
            "The managed block source is the Codex-specific orchestrator instruction body (`providers/codex/instructions/480-orchestrator.md`), and the design architect is a separate conditional subagent.",
        "",
        "## Name mapping",
        "",
    ]
    ...
    lines.extend(
        [
            ...
            "- The root calls `480-design-architect` only for behavior-changing work: functionality, policy, invariant, state transition, externally observable behavior, public API/data contract/schema, configuration semantics, or architecture changes.",
            "- The root skips design delegation for maintenance work such as bug fixes, failing tests, compile errors, wiring fixes, assertion corrections, documentation-only updates, generated-output synchronization, and minimal defect remediation.",
            "- Design Contract or Minimal Transfer Analysis output is embedded into the Task Brief under `Design Input`; v1 does not create separate design artifact files.",
            ...
            "For behavior-changing work, have 480-design-architect produce a Design Contract and embed it in the Task Brief under `Design Input`.",
